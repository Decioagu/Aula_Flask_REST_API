...
class SiteModel(banco.Model):
    ...
    # método filtro (.\resources\site.py: GET/POST/DELETE)
    @classmethod # recebe a própria como argumento "cls"
    def filtro_por_id_URL(cls, url):
    ...
    @classmethod # recebe a própria como argumento "cls"
    def filtro_por_site_id(cls, site_id):
        # filtra Banco de dados e retorna 1º resultado
    ...
    def delete_site(self):
        ...
        # deletar lista de hotéis associado ao "site_id"
